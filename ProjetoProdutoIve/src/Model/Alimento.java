...
public class Alimento extends Produto {
	...
	public Alimento(int codUnico, String nomeProd, String descricao, int quantidade, double preco,
			String dataValidade) {
	...
	public void cadastrarAlimento() {
		...
		gravaEstoque("estoque.txt", codProd, nomeProd, descProd, quant, preco, dataValidade);
